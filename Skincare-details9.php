                    ...
                    <div class="service-content mb-30">
                        ...
                        <div class="row mt-40 mb-20">
                            <div class="col-lg-4 mb-30">
                                <img src="assets/img/therapy11.png" alt="Service Image" class="w-100">
                            </div>
                            <div class="col-lg-4 mb-30">
                                <img src="assets/img/therapy12.png" alt="Service Image" class="w-100">
                            </div>
                            <div class="col-lg-4 mb-30">
                                <img src="assets/img/therapy13.png" alt="Service Image" class="w-100">
                            </div>
                        </div>
