                    ...
                    <div class="service-content mb-30">
                        ...
                        <div class="row mt-40 mb-20">
                            <div class="col-lg-4 mb-30">
                                <img src="assets/img/eczema footer image 1.jpg" alt="Service Image" class="w-100">
                            </div>
                            <div class="col-lg-4 mb-30">
                                <img src="assets/img/eczema footer image 2.jpg" alt="Service Image" class="w-100">
                            </div>
                            <div class="col-lg-4 mb-30">
                                <img src="assets/img/eczema footer image 3.jpg" alt="Service Image" class="w-100">
                            </div>
                        </div>
