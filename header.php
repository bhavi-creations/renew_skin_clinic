...
<body class="">
  ...
  ==============================-->
    ...
    <!-- Marquee Section -->
    <marquee behavior="" direction="" class="" style="background-color: #2d3789; color: white; padding: 10px; margin: 0; display: block;">
    ...
    <nav class="navbar navbar-expand-lg bg-light p-3" style="margin-top: 0; font-size: 18px;">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="index.php">
                <img src="assets/img/logo.png" alt="Logo" height="80" width="100">
            </a>

            <!-- Toggle Button -->
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav"
                aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"
                style="border: 1px solid #000; padding: 4px 8px;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto  gap-3">
                    ...
                    <li class="nav-item dropdown position-relative">
                        ...
                        <ul class="dropdown-menu mt-2 p-3 subservice_section" aria-labelledby="servicesDropdown" >
                            <div class="row  ">
                    ...
                    <li class="nav-item">
                        <a href="appointment.php" class="btn vs-btn btn-sm">Appointment</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="header-top bg-title py-2 d-none d-lg-block slider_space_content" style="background-color: #f8f9fa;">
        <div class="container py-1">
            <div class="row justify-content-between align-items-center">
                <div class="col-auto">
                    <ul class="header-top-info list-unstyled m-0 d-flex gap-3">
                        <li><i class="far fa-envelope"></i> <a href="mailto:renewneurostar@gmail.com" class="text-reset">renewneurostar@gmail.com </a></li>
